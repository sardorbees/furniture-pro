                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="footer__widget">
                                    ...
                                    <div class="footer__widget--inner">
                                        ...
                                        <p class="footer__widget--desc">Ибо, чтобы подойти к делу, кто <br/> Наше упражнение — любой труд. <br/> если только это не принесет вам никакой пользы.</p>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="footer__widget">
                                        ...
                                        <ul class="footer__widget--menu footer__widget--inner">
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">О нас</a></li>
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">Список желаний</a></li>
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">Связаться с нами</a></li>
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">политика конфиденциальности</a></li>
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" >Часто</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="footer__widget">
                                        <h2 class="footer__widget--title ">Информация об учетной записи <button class="footer__widget--button" aria-label="footer widget button"></button>
                                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                        </h2>
                                        <ul class="footer__widget--menu footer__widget--inner">
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">Мой счет</a></li>
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">Корзина</a></li>
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">Авторизоваться</a></li>
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">Зарегистрироваться</a></li>
                                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text">Проверить</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
